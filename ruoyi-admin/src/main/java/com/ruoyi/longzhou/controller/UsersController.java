 ...
 * @date 2025-07-24
 */
@RestController("longzhouUsersController")
@RequestMapping("/longzhou/users")
public class UsersController extends BaseController
{
     ...
     * 查询用户管理列表
     */
    @PreAuthorize("@ss.hasPermi('longzhou:users:list')")
    @GetMapping("/list")
     ...
     * 导出用户管理列表
     */
    @PreAuthorize("@ss.hasPermi('longzhou:users:export')")
     ...
     * 获取用户管理详细信息
     */
    @PreAuthorize("@ss.hasPermi('longzhou:users:query')")
     ...
     * 新增用户管理
     */
    @PreAuthorize("@ss.hasPermi('longzhou:users:add')")
     ...
     * 修改用户管理
     */
    @PreAuthorize("@ss.hasPermi('longzhou:users:edit')")
     ...
     * 删除用户管理
     */
    @PreAuthorize("@ss.hasPermi('longzhou:users:remove')")
